...
const awsconfig = {
  ...
  aws_cognito_identity_pool_id:
    "us-east-1:27ece60b-49b7-4e48-8595-2af5cde38f46", // Update this if needed
  ...
  oauth: {
    ...
    responseType: "code", // Use "code" for PKCE
    googleClientId:
      "433108609704-db81ls0o6m7ittfd5gj0cvald67uktku.apps.googleusercontent.com", // Update this if needed
  },
};
